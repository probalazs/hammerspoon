...
hs.urlevent.bind("open-emarsys-vpn", function(_, params)
  connectToVpn.run(params.connection, params.user, params.code)
end)

hs.urlevent.bind("reload-hammerspoon-config", function()
  reloadHammerspoon.run()
end)
