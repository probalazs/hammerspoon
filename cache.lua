...
local getCacheFolder = function() return hs.fs.temporaryDirectory() .. 'hs-' .. os.date('%Y%m%d') end
...
local getCache = function(file) return getFileContent(getCacheFolder() .. '/' .. file) end
